...
type IGiteaClient =
    ...
    /// Update a branch
    [<RestEase.Post "repos/{owner}/{repo}/branches/{branch}">]
    [<RestEase.Header("Content-Type", "json")>]
    ...
    [<RestEase.Post "repos/{owner}/{repo}/issues/{index}/pin/{position}">]
    [<RestEase.Header("Content-Type", "json")>]
    ...
    [<RestEase.Post "repos/{owner}/{repo}/tag_protections/{id}">]
    [<RestEase.Header("Content-Type", "json")>]
